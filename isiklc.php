...
<?php
            ...
            if(isset($_POST["submit"])){
                ...
                $tanggal = $_POST["klcdate"];
                $idfile = $_POST["idfile"];
                $nidn = $_POST["nidn"];
                $query = "INSERT INTO konfirmasi_layak_cetak values('','$tanggal',$id,'$id_akun')";
...
<body>
	<form action="" method="post">
		...
		-->
		<tr>
				<td><h4><b>Tanggal Pengesahan KLC </b></h4></td>
				<td><input type="date" name="klcdate"></td>
			</tr>
            <tr>
                <td>
